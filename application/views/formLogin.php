              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sistem Monitoring Aktivitas Lalu Lintas <br> <b>SMALL ITS</b></h1>
                  </div>
                  ...
                  <div>
                    <a href="#">Scan Access Card / Barcode karcis</a>
                    <a href="<?= base_url('lupaPassword'); ?>" style="margin-left: 80px;">Lupa Password</a>
                  </div>
                </div>
              </div>
            </div>
